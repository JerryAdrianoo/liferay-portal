...
public class SidecarClassFileTransformer implements ClassFileTransformer {
	...
	private static final String _CONSTANT_A = "org/elasticsearch/bootstrap/Elasticsearch";
	private static final String _CONSTANT_B = "org/elasticsearch/common/settings/KeyStoreWrapper";
}